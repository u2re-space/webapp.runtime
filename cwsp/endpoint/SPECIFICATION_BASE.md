...
```
{
    ...
    role: [("requestor" | "responser" | "acceptor" | "executor" | "actor" | "bridge" | "link" | "exchanger" | "sender")...], # what role will after request, also "bridge" or "link", I don't know how to name truly...
