import { a as __toESM } from "../chunks/rolldown-runtime.js";
import { A as purify, D as BaseElement_default, Dt as ensureStyleSheet, Gn as removeAdopted, Gt as decodeBase64ToBytes, Hn as loadAsAdopted, Jt as parseDataUrl, Kt as isBase64Like, O as createViewState, Ot as reinitializeRegistry, Qt as provide, St as __decorate, Zt as openDirectory, cn as H, dn as affected, gt as loadSettings, hn as ref, in as defineElement, k as renderMathInElement, mt as writeText, qt as normalizeDataAsset } from "../com/app.js";
import { t as require_quill } from "../vendor/quill.js";
...
var getMarkedParser = async () => {
	...
	markedParserPromise = (async () => {
		const [{ marked }, { default: markedKatex }] = await Promise.all([import("../com/app.js").then((n) => n.v), import("../com/app.js").then((n) => n.g)]);
...
var STORAGE_KEY$1 = "rs-viewer-state";
var DEFAULT_CONTENT$1 = `# This is content`;
var ViewerView = class ViewerView extends BaseElement_default {
	...
	contentRef = ref("");
	renderSeq = 0;
	stateManager = createViewState(STORAGE_KEY$1);
	_sheet = null;
	...
	constructor(options = {}) {
		...
		this.contentRef.value = options.initialContent || savedState?.content || DEFAULT_CONTENT$1;
...
*/
function createView$1(options) {
	return new ViewerView(options);
}
/** Alias for createView */
var createMarkdownView = createView$1;
/**
...
var import_quill = /* @__PURE__ */ __toESM(require_quill(), 1);
...
//#endregion
//#region src/frontend/views/editor/editor.scss?inline
...
//#endregion
//#region src/frontend/views/editor/index.ts
/**
* Editor View
*
...
var EditorView = class {
	...
	async handleCopy() {
		try {
			const result = await writeText(this.contentRef.value);
			if (!result.ok) throw new Error(result.error || "Clipboard write failed");
...
//#endregion
export { createQuillEditor as a, createMarkdownEditor as c, createView$1 as d, warmViewerMarkdownEngine as f, QuillEditor as i, ViewerView as l, createEditorView as n, deltaToHtml as o, createView as r, MarkdownEditor as s, EditorView as t, createMarkdownView as u };
