import { o as ROUTE_HASHES } from "../com/service.js";
import { a as initializeComponent, l as sendMessage, s as registerComponent } from "../com/service4.js";
import { n as consumeCachedShareTargetPayload, r as fetchCachedShareFiles } from "../com/service5.js";
import { V as H, d as isBase64Like, f as normalizeDataAsset, p as parseDataUrl } from "../com/app3.js";
import { i as buildInstructionPrompt } from "../com/service7.js";
...
import "../com/service20.js";
import { t as summarizeForLog } from "../com/app10.js";
import { a as getCustomInstructions, o as getInstructionRegistry, s as setActiveInstruction } from "../com/service24.js";
import { s as toBase64 } from "../com/service25.js";
import { t as processDataWithInstruction } from "../com/service26.js";
import "../com/service27.js";
import { t as WorkCenterStateManager } from "./workcenter.js";
import { t as WorkCenterDataProcessing } from "./workcenter2.js";
...
var WorkCenterShareTarget = class {
	...
	async addShareTargetResult(state, resultData) {
		...
		const { WorkCenterStateManager } = await import("./workcenter.js").then((n) => n.n);
	...
	async addShareTargetInput(state, inputData) {
		...
		try {
			...
			const { WorkCenterStateManager: StateManager } = await import("./workcenter.js").then((n) => n.n);
...
var WorkCenterTemplates = class {
	...
	async getDefaultTemplates() {
		const { DEFAULT_INSTRUCTION_TEMPLATES } = await import("../com/service3.js").then((n) => n.r);
...
var WorkCenterActions = class {
	...
	async viewResultsInViewer(state) {
		...
		try {
			const { unifiedMessaging } = await import("../com/service4.js").then((n) => n.t);
...
var WorkCenterEvents = class {
	...
	setupFormatSelectors() {
		...
		formatSelect.addEventListener("change", async () => {
			...
			if (this.state.lastRawResult) {
				...
				const { WorkCenterDataProcessing } = await import("./workcenter2.js").then((n) => n.n);
		...
		this.container.addEventListener("click", async (e) => {
			...
			switch (action) {
				...
				case "clear-recognized":
					const { WorkCenterStateManager: StateManager1 } = await import("./workcenter.js").then((n) => n.n);
					...
					break;
				case "clear-pipeline":
					const { WorkCenterStateManager: StateManager2 } = await import("./workcenter.js").then((n) => n.n);
	...
	switchInputTab(tab) {
		...
		import("./workcenter.js").then((n) => n.n).then(({ WorkCenterStateManager }) => WorkCenterStateManager.saveState(this.state)).catch(() => {});
	}
