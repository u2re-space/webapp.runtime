...
import { l as requestOpenView, n as ViewRegistry } from "../chunks/registry.js";
import { a as decodeBase64ToBytes, c as parseDataUrl, g as provide, h as openDirectory, o as isBase64Like, q as H, s as normalizeDataAsset } from "../com/app.js";
...
var getMarkedParser = async () => {
	...
	markedParserPromise = (async () => {
		const [{ marked }, { default: markedKatex }] = await Promise.all([import("../vendor/marked.js").then((n) => n.n), import("../vendor/katex.js").then((n) => n.n)]);
...
*/
//#endregion
export { CwViewViewer, CwViewViewer as ViewerView, TAG, warmViewerMarkdownEngine };
