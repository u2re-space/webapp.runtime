...
import { t as createViewConstructor } from "../chunks/registry.js";
	...
	return class ViewerView extends Base {
		...
		*/
		...
		async navigateSingletonShell(viewId) {
			try {
				const { bootLoader } = await import("../chunks/BootLoader.js").then((n) => n.n);
