import { Dn as unifiedMessaging, Gn as removeAdopted, H as showToast, Hn as loadAsAdopted, Ln as BROADCAST_CHANNELS, a as dispatchViewTransfer, cn as H, gt as loadSettings, l as copy, o as summarizeForLog, p as eventTargetElement, u as initClipboardReceiver, z as initToastReceiver } from "../com/app.js";
import { F as storeShareTargetPayloadToCache$1, M as consumeCachedShareTargetPayload$1 } from "../com/service.js";
import { A as setAirpadCredentialInvalidator, C as getRemoteProtocol, D as isShellRemoteClipboardBridgeEnabled, E as isPushLocalClipboardToLanEnabled, O as reloadAirpadRemoteConfigFromStorage, S as getRemoteHost, T as isApplyRemoteClipboardToDeviceEnabled, _ as getAirPadPeerInstanceId, b as getClipboardBroadcastTargetNodes, d as REL_ORIENT_SMOOTH, f as applyAirpadRemoteConfig, g as getAirPadClientId, h as getAirPadAuthToken, k as invalidateAirpadTransportCredentials, m as attachAirpadCrossTabConfigSync, u as REL_ORIENT_DEADZONE, v as getAirPadTransportMode, w as getRemoteRouteTarget, x as getClipboardPushIntervalMs, y as getAirPadTransportSecret } from "../shells/boot-index.js";
...
var processShareTargetData = async (shareData, skipIfEmpty = false) => {
	...
	try {
		...
		if (result.success && result.data) {
			...
			clipboardChannel.close();
			try {
				const { unifiedMessaging } = await import("../com/app.js").then((n) => n._n);
				await unifiedMessaging.sendMessage({
					type: "share-target-result",
					source: "share-target",
					destination: "workcenter",
...
async function initAirpadApp(initToken, signal, domMountRoot) {
	...
	bindBus("ui.admin.open", () => {
		import("../com/app.js").then((n) => n.ht).then(({ loadSettings }) => loadSettings()).then((s) => import("../chunks/admin-doors.js").then(({ openAdminDoorFromCore }) => {
...
//#endregion
export { initReceivers as C, handleShareTarget as S, ensureServiceWorkerRegistered as T, openNativeNotificationSettings as _, unmountAirpadRuntime as a, checkPendingShareData as b, initWebSocket as c, onVoiceResult as d, onWSConnectionChange as f, openAppClipboardRelatedSettings as g, isCapacitorNativeShell as h, mountAirpad as i, isWSConnected as l, sendCoordinatorRequest as m, createAirpadView as n, connectWS as o, sendCoordinatorAct as p, createView as r, disconnectWS as s, AirpadView as t, onServerClipboardUpdate as u, readClipboardTextFromDevice as v, setupLaunchQueueConsumer as w, ensureAppCss as x, writeClipboardTextToDevice as y };
