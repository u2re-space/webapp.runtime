...
import { c as observe, u as ref } from "../fest/object.js";
import { t as DEFAULT_INSTRUCTION_TEMPLATES } from "../com/service3.js";
import { l as sendMessage } from "../com/service4.js";
import { V as H } from "../com/app3.js";
import { t as BUILTIN_AI_MODELS } from "../com/service10.js";
import { i as saveSettings, r as loadSettings } from "../com/service11.js";
import { t as applyTheme } from "../com/service12.js";
import { i as applyAirpadRuntimeFromAppSettings } from "./airpad.js";
import { o as navigateToView } from "../shells/boot-ts-routing.js";
import { a as setString, t as StorageKeys } from "../com/service18.js";
import { n as openAdminDoorFromCore, r as resolveAdminDoorUrls } from "../com/service23.js";
import { c as updateInstruction, i as deleteInstruction, n as addInstruction, o as getInstructionRegistry, r as addInstructions, s as setActiveInstruction } from "../com/service24.js";
		...
		(async () => {
			...
			const saved = await saveSettings({
				...
				shell: {
					...
					clipboardPushIntervalMs: Math.max(800, Math.min(6e4, parseNumberOrDefault(shellClipboardPushMs?.value, current.shell?.clipboardPushIntervalMs ?? 2e3))),
			...
			import("../com/service14.js").then((n) => n.n).then((m) => m.applyHubSocketFromSettings(saved));
			applyTheme(saved);
