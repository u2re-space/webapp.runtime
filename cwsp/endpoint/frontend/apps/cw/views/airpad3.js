import { a as initServiceWorker, c as eventTargetElement } from "../com/app.js";
...
async function initAirpadApp(initToken, signal, domMountRoot) {
	...
	bindBus("ui.admin.open", () => {
		import("../com/service11.js").then((n) => n.t).then(({ loadSettings }) => loadSettings()).then((s) => import("../com/service23.js").then((n) => n.t).then(({ openAdminDoorFromCore }) => {
...
//#endregion
export { disconnectAirPadSession as a, waitForDomPaint as i, unmountAirpadRuntime as n, setRemoteKeyboardEnabled as r, mountAirpad as t };
