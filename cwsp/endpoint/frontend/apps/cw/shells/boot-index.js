import { $t as LongPressHandler, Bn as isProtocolEnvelope, F as setAppWallpaper, Fn as serviceChannels, G as loadVeelaVariant, Hn as loadAsAdopted, I as closeUnifiedContextMenu, Jn as fixOrientToScreen, K as applyTheme, Kn as setStyleProperty, L as openUnifiedContextMenu, P as initializeAppCanvasLayer, Qn as redirectCell, U as WebPlugin, Vn as normalizeProtocolEnvelope, W as registerPlugin, Xn as RAFBehavior, dn as affected, en as clampCell$1, fn as numberRef, gn as makeObjectAssignable, gt as loadSettings, nn as makeShiftTrigger, pn as observe, pt as initClipboardReceiver, qn as resolveGridCellFromClientPoint, sn as registerModal, tn as bindDraggable, yt as DEFAULT_SETTINGS, z as initToastReceiver, zn as createProtocolEnvelope } from "../com/app.js";
import { j as loadSettings$1 } from "../com/service.js";
...
async function bootHubSocketFromStoredSettings() {
	await applyHubSocketFromSettings(await loadSettings$1());
}
/**
...
async function applyHubSocketFromSettings(settings) {
	...
	const { initWebSocket, connectWS } = await import("../chunks/websocket.js");
	initWebSocket(null);
	connectWS();
}
//#endregion
...
//#endregion
export { setAirpadCredentialInvalidator as A, getRemoteProtocol as C, isShellRemoteClipboardBridgeEnabled as D, isPushLocalClipboardToLanEnabled as E, isCapacitorCwsNativeShell as F, isCwsNativeIpcAvailable as I, isElectronCwsNativeShell as L, getNativeUnifiedSettings as M, initCwsNativeBridge as N, reloadAirpadRemoteConfigFromStorage as O, invokeCwsPlatformIPC as P, patchNativeUnifiedSettings as R, getRemoteHost as S, isApplyRemoteClipboardToDeviceEnabled as T, getAirPadPeerInstanceId as _, loadSubAppWithShell as a, getClipboardBroadcastTargetNodes as b, bootHubSocketFromStoredSettings as c, REL_ORIENT_SMOOTH as d, applyAirpadRemoteConfig as f, getAirPadClientId as g, getAirPadAuthToken as h, getShellFromQuery as i, CwsBridge as j, invalidateAirpadTransportCredentials as k, MOTION_JITTER_EPS as l, attachAirpadCrossTabConfigSync as m, VALID_VIEWS as n, navigateToView as o, applyAirpadRuntimeFromAppSettings as p, getSavedShellPreference as r, applyHubSocketFromSettings as s, ensureAppLayers as t, REL_ORIENT_DEADZONE as u, getAirPadTransportMode as v, getRemoteRouteTarget as w, getClipboardPushIntervalMs as x, getAirPadTransportSecret as y, initializeLayers as z };
