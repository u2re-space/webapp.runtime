import { E as MOCElement, I as isInFocus, O as addEvent, _ as preloadStyle, a as handleStyleChange, g as loadInlineStyle, h as loadAsAdopted, v as removeAdopted } from "../fest/dom.js";
import { _ as isUserScopePath, c as observe, l as propRef, r as affected, u as ref } from "../fest/object.js";
import { t as requestOpenView } from "../views/api.js";
import { C as provide, D as writeFile, E as uploadFile, F as GLitElement, G as bindWith, I as defineElement, L as property, O as initGlobalClipboard, S as openDirectory, T as remove, V as H, _ as getDirectoryHandle, b as handleIncomingEntries, d as isBase64Like, f as normalizeDataAsset, g as getDir, h as downloadFile, k as ctxMenuTrigger, p as parseDataUrl, u as decodeBase64ToBytes, v as getFileHandle, w as readFile, y as getMimeTypeByFilename } from "./app3.js";
import { o as ensureStyleSheet, s as reinitializeRegistry, t as UIPhosphorIcon } from "../fest/icon.js";
...
import { n as UIElement_default, t as BaseElement$1 } from "./app8.js";
...
import { t as BaseElement_default } from "../views/base.js";
import "./service15.js";
import "./service16.js";
import "./service17.js";
//#region shared/fest/fl-ui/ui/items/image/Canvas.ts
...
//#endregion
//#region shared/fest/fl-ui/ui/items/explorer/ContextMenu.ts
...
//#endregion
//#region shared/fest/fl-ui/ui/items/explorer/utils.ts
/**
...
//#endregion
//#region shared/fest/fl-ui/ui/items/explorer/FileManagerContent.ts
initGlobalClipboard();
var styled$4 = preloadStyle(FileManagerContent_default$1);
var FileManagerContent = class FileManagerContent extends BaseElement$1 {
	gridRowsEl;
	gridEl;
...
var styled$1 = preloadStyle("@property --client-x{initial-value:0;syntax:\"<number>\";inherits:true}@property --client-y{initial-value:0;syntax:\"<number>\";inherits:true}@property --page-x{initial-value:0;syntax:\"<number>\";inherits:true}@property --page-y{initial-value:0;syntax:\"<number>\";inherits:true}@property --sp-x{initial-value:0px;syntax:\"<length-percentage>\";inherits:true}@property --sp-y{initial-value:0px;syntax:\"<length-percentage>\";inherits:true}@property --ds-x{initial-value:0px;syntax:\"<length-percentage>\";inherits:true}@property --ds-y{initial-value:0px;syntax:\"<length-percentage>\";inherits:true}@property --rx{initial-value:0px;syntax:\"<length-percentage>\";inherits:true}@property --ry{initial-value:0px;syntax:\"<length-percentage>\";inherits:true}@property --rs-x{initial-value:0px;syntax:\"<length-percentage>\";inherits:true}@property --rs-y{initial-value:0px;syntax:\"<length-percentage>\";inherits:true}@property --limit-shift-x{initial-value:100%;syntax:\"<length-percentage>\";inherits:true}@property --limit-shift-y{initial-value:100%;syntax:\"<length-percentage>\";inherits:true}@property --limit-drag-x{initial-value:100%;syntax:\"<length-percentage>\";inherits:true}@property --limit-drag-y{initial-value:100%;syntax:\"<length-percentage>\";inherits:true}@property --bound-inline-size{initial-value:100%;syntax:\"<length-percentage>\";inherits:true}@property --bound-block-size{initial-value:100%;syntax:\"<length-percentage>\";inherits:true}@property --inline-size{initial-value:100%;syntax:\"<length-percentage>\";inherits:true}@property --block-size{initial-value:100%;syntax:\"<length-percentage>\";inherits:true}@property --initial-inline-size{initial-value:100%;syntax:\"<length-percentage>\";inherits:true}@property --initial-block-size{initial-value:100%;syntax:\"<length-percentage>\";inherits:true}@property --scroll-coef{syntax:\"<number>\";initial-value:1;inherits:true}@property --scroll-size{syntax:\"<number>\";initial-value:0;inherits:true}@property --content-size{syntax:\"<number>\";initial-value:0;inherits:true}@property --max-size{syntax:\"<length-percentage>\";initial-value:0px;inherits:true}@function --hsv(--src-color <color>) returns <color>{result:hsl(from var(--src-color,black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100)/alpha)}@layer components{ui-icon{--icon-color:currentColor;--icon-size:1rem;--icon-padding:0.125rem;aspect-ratio:1;color:var(--icon-color);display:inline-grid;margin-inline-end:.125rem;place-content:center;place-items:center;vertical-align:middle}ui-icon:last-child{margin-inline-end:0}}");
...
var ViewerView = class ViewerView extends BaseElement_default {
	...
	render = function(options) {
		...
		this._sheet = loadAsAdopted(markdown_view_default);
	...
	*/
	...
	async handleExportDocx() {
		...
		try {
			const { downloadMarkdownAsDocx } = await import("./service19.js").then((n) => n.t);
	...
	async handleAttachToWorkCenter() {
		...
		try {
			const { ViewRegistry } = await import("./app2.js").then((n) => n.s);
...
observe(/* @__PURE__ */ new Map());
//#endregion
//#region shared/fest/fl-ui/ui/items/base/BaseElement.ts
...
//#endregion
export { setAppWallpaper as i, FileManagerContent_default as n, initializeAppCanvasLayer as r, FileManager_default as t };
