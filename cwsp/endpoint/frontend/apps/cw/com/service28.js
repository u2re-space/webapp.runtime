...
import { c as getBroadcastChannelForDestination, n as BROADCAST_CHANNELS } from "./service.js";
import { n as DEFAULT_TEMPLATES } from "./service3.js";
import { a as initializeComponent, d as unifiedMessaging, i as hasPendingMessages, n as createMessageWithOverrides, o as processInitialContent, r as enqueuePendingMessage, s as registerComponent } from "./service4.js";
import { i as fetchSwCachedEntries } from "./service5.js";
import { V as H, c as getCachedComponent } from "./app3.js";
import { i as testIconRacing, l as clearAllCache, n as clearIconCaches, o as ensureStyleSheet, r as debugIconSystem, s as reinitializeRegistry } from "../fest/icon.js";
import { r as loadSettings } from "./service11.js";
import { t as views_default } from "../chunks/views2.js";
import { t as createFileHandler } from "./service21.js";
	...
	*/
	...
	const renderHistoryView = async () => {
      ...
      <span>Loading History...</span>
		...
		content.append(loadingElement);
		try {
			const historyManager = (await getCachedComponent("history-manager", () => import("./app9.js").then((n) => n.t), { componentName: "HistoryManager" })).component.createHistoryManager();
	...
	const runPrompt = async (promptText, customAIFunction) => {
		...
		try {
			const res = customAIFunction ? await customAIFunction(input, { useActiveInstruction: true }) : await (await import("./service26.js").then((n) => n.n)).recognizeByInstructions(input, instructions);
