...
//#region src/com/config/Settings.ts
...
var loadSettings = async () => {
	try {
		...
		if (stored && typeof stored === "object") {
			...
			try {
				const { getNativeUnifiedSettings, isCwsNativeIpcAvailable } = await import("./app11.js");
...
var saveSettings = async (settings) => {
	...
	try {
		const { patchNativeUnifiedSettings, isCwsNativeIpcAvailable } = await import("./app11.js");
...
//#endregion
export { saveSettings as i, currentWebDav as n, loadSettings as r, Settings_exports as t };
