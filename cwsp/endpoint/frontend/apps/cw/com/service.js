import { An as DEFAULT_TEMPLATES, Bt as generateInstructionId, En as sendProtocolMessage, Ft as JSOX, Ht as getOutputFormatInstruction, In as API_ENDPOINTS, It as LANGUAGE_INSTRUCTIONS, Lt as SVG_GRAPHICS_ADDON, Mn as CORE_DATA_CONVERSION_INSTRUCTION, Mt as canParseURL, Nn as CORE_ENTITY_EXTRACTION_INSTRUCTION, Pn as CORE_IMAGE_INSTRUCTION, Rt as TRANSLATE_INSTRUCTION, Vt as getIntermediateRecognitionInstruction, _t as saveSettings, cn as H, d as STRICT_JSON_INSTRUCTIONS, f as extractJSONFromAIResponse, gt as loadSettings$1, qt as normalizeDataAsset, yt as DEFAULT_SETTINGS, zn as createProtocolEnvelope, zt as buildInstructionPrompt } from "./app.js";
...
var loadSettings = async () => {
	try {
		...
		if (stored && typeof stored === "object") {
			...
			try {
				const { getNativeUnifiedSettings, isCwsNativeIpcAvailable } = await import("../chunks/cws-bridge.js");
...
var loadLureFs = () => {
	if (!lureFsPromise) lureFsPromise = import("./app.js").then((n) => n.jt).then((m) => ({
	...
	return Promise.all(files.map(async (file) => {
		...
		if (file?.type === "file") {
			...
			if (safeTime(file?.lastmod) > localMtime) {
				...
				const { writeFileSmart } = await import("./app.js").then((n) => n.Nt);
...
async function getDefaultProvider() {
	...
	const { loadSettings } = await import("./app.js").then((n) => n.ht);
...
//#endregion
//#region src/com/core/UniformViewTransport.ts
...
//#endregion
export { getRuntimeSettings as A, getCustomInstructions as C, openAdminDoorFromCore as D, updateInstruction as E, storeShareTargetPayloadToCache as F, consumeCachedShareTargetPayload as M, fetchCachedShareFiles as N, openAdminDoorUrl as O, fetchSwCachedEntries as P, getActiveInstructionText as S, setActiveInstruction as T, getGPTInstance as _, createTemplateManager as a, deleteInstruction as b, analyzeRecognizeUnified as c, getActiveCustomInstruction as d, getLanguageInstruction as f, extractEntities as g, detectPlatform as h, sendViewProtocolMessage as i, loadSettings as j, resolveAdminDoorUrls as k, convertTextualData as l, loadAISettings as m, actionHistory as n, processDataWithInstruction as o, getSvgGraphicsAddon as p, normalizeIpcAttachments as r, recognizeByInstructions as s, executionCore as t, recognizeImageData as u, addInstruction as v, getInstructionRegistry as w, getActiveInstruction as x, addInstructions as y };
