...
var CwViewViewer = createViewConstructor(TAG, (Base) => {
	return class ViewerView extends Base {
		constructor(options = {}) {
			...
			this.contentRef = ref("");
			this.renderSeq = 0;
			this.stateManager = createViewState(STORAGE_KEY);
			this._sheet = null;
			...
			this.markdownSettingsPromise = null;
...
//#endregion
export { CwViewViewer, CwViewViewer as ViewerView, TAG, src_default as default, warmViewerMarkdownEngine };
