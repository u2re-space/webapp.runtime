...
//#region ../../node_modules/mathml-to-latex/dist/bundle.min.js
var require_bundle_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		...
		var e = {
				...
				d.prototype.parseFromString = function(e, t) {
					...
					characters: function(e, t, r) {
						if (e = x.apply(this, arguments)) {
							if (this.cdata) var a = this.doc.createCDATASection(e);
							else a = this.doc.createTextNode(e);
							this.currentElement ? this.currentElement.appendChild(a) : /^\s*$/.test(e) && this.doc.appendChild(a), this.locator && p(this.locator, a);
						}
					},
			...
			4722: (e, t, r) => {
				...
				function T(e, t) {
					...
					else r = this, Error.call(this, _[e]), this.message = _[e], Error.captureStackTrace && Error.captureStackTrace(this, T);
				...
				function P(e, t, r) {
					var a = S(t, r);
					if (!(a >= 0)) throw new T(D, /* @__PURE__ */ new Error(e.tagName + "@" + r));
				...
				function $(e, t) {
					...
					return r ? r.nextSibling = a : e.firstChild = a, a ? a.previousSibling = r : e.lastChild = r, t.parentNode = null, t.previousSibling = null, t.nextSibling = null, G(e.ownerDocument, e), t;
				}
				function X(e) {
				...
				function Q(e, t, r, a) {
					...
					o.previousSibling = s, i.nextSibling = r, s ? s.nextSibling = o : e.firstChild = o, null == r ? e.lastChild = i : r.previousSibling = i;
					do
						o.parentNode = e;
					while (o !== i && (o = o.nextSibling));
					return G(e.ownerDocument || e, e), t.nodeType == A && (t.firstChild = t.lastChild = null), t;
				}
				function K() {
					this._nsMap = {};
				}
					...
					switch (e.nodeType) {
						case d:
							...
							if (!(r = o.isHTML(e.namespaceURI) || r) && !e.prefix && e.namespaceURI) {
								...
								if (!h) {
									for (var E = n.length - 1; E >= 0; E--) if ("" === (y = n[E]).prefix && y.namespace === e.namespaceURI) {
										h = y.namespace;
										break;
									}
								}
							...
							for (_ = 0; _ < s; _++) {
								var q, D, M;
								me(q = i.item(_), 0, n) && (pe(t, (D = q.prefix || "") ? "xmlns:" + D : "xmlns", M = q.namespaceURI), n.push({
									prefix: D,
									namespace: M
								})), fe(q, t, r, a, n);
							}
							if (c === u && me(e, 0, n) && (pe(t, (D = e.prefix || "") ? "xmlns:" + D : "xmlns", M = e.namespaceURI), n.push({
								prefix: D,
								namespace: M
							})), l || r && !/^(?:meta|link|img|br|hr|input)$/i.test(c)) {
								if (t.push(">"), r && /^script$/i.test(c)) for (; l;) l.data ? t.push(l.data) : fe(l, t, r, a, n.slice()), l = l.nextSibling;
								else for (; l;) fe(l, t, r, a, n.slice()), l = l.nextSibling;
								t.push("</", u, ">");
							} else t.push("/>");
							return;
						case v:
						case A:
							...
							return;
						case m: return pe(t, e.name, e.value);
						case p: return t.push(e.data.replace(/[<&>]/g, I));
						case f: return t.push("<![CDATA[", e.data, "]]>");
						case b: return t.push("<!--", e.data, "-->");
						case C:
							var T = e.publicId, N = e.systemId;
							if (t.push("<!DOCTYPE ", e.name), T) t.push(" PUBLIC ", T), N && "." != N && t.push(" ", N), t.push(">");
							...
							return;
						case w: return t.push("<?", e.target, " ", e.data, "?>");
						case x: return t.push("&", e.nodeName, ";");
				...
				function xe(e, t, r) {
					var a;
					switch (t.nodeType) {
						case d: (a = t.cloneNode(!1)).ownerDocument = e;
						case A: break;
						case m: r = !0;
					}
					if (a || (a = t.cloneNode(!1)), a.ownerDocument = e, a.parentNode = null, r) for (var n = t.firstChild; n;) a.appendChild(xe(e, n, r)), n = n.nextSibling;
					return a;
				}
				function ge(e, t, r) {
				...
				y.INVALID_STATE_ERR = (_[11] = "Invalid state", 11), y.SYNTAX_ERR = (_[12] = "Syntax error", 12), y.INVALID_MODIFICATION_ERR = (_[13] = "Invalid modification", 13), y.NAMESPACE_ERR = (_[14] = "Invalid namespace", 14), y.INVALID_ACCESS_ERR = (_[15] = "Invalid access", 15), T.prototype = Error.prototype, c(y, T), N.prototype = {
					length: 0,
					item: function(e) {
					...
					createDocument: function(e, t, r) {
						var a = new U();
						if (a.implementation = this, a.childNodes = new N(), a.doctype = r || null, r && a.appendChild(r), t) {
					...
					lookupPrefix: function(e) {
						for (var t = this; t;) {
							var r = t._nsMap;
							if (r) {
								for (var a in r) if (Object.prototype.hasOwnProperty.call(r, a) && r[a] === e) return a;
							}
					...
					createElement: function(e) {
						var t = new K();
						return t.ownerDocument = this, t.nodeName = e, t.tagName = e, t.localName = e, t.childNodes = new N(), (t.attributes = new B())._ownerElement = t, t;
					},
					...
					createElementNS: function(e, t) {
						...
						return r.childNodes = new N(), r.ownerDocument = this, r.nodeName = t, r.tagName = t, r.namespaceURI = e, 2 == a.length ? (r.prefix = a[0], r.localName = a[1]) : r.localName = t, n._ownerElement = r, r;
					},
					createAttributeNS: function(e, t) {
						var r = new ee(), a = t.split(":");
						return r.ownerDocument = this, r.nodeName = t, r.name = t, r.namespaceURI = e, r.specified = !0, 2 == a.length ? (r.prefix = a[0], r.localName = a[1]) : r.localName = t, r;
					}
				}, u(U, R), K.prototype = {
					nodeType: d,
				...
				}, U.prototype.getElementsByTagName = K.prototype.getElementsByTagName, U.prototype.getElementsByTagNameNS = K.prototype.getElementsByTagNameNS, u(K, R), ee.prototype.nodeType = m, u(ee, R), te.prototype = {
					data: "",
					...
					replaceData: function(e, t, r) {
						r = this.data.substring(0, e) + r + this.data.substring(e + t), this.nodeValue = this.data = r, this.length = r.length;
					}
				}, u(te, R), re.prototype = {
					nodeName: "#text",
					nodeType: p,
					...
					nodeType: f
				}, u(ne, te), oe.prototype.nodeType = C, u(oe, R), ie.prototype.nodeType = E, u(ie, R), se.prototype.nodeType = g, u(se, R), le.prototype.nodeType = x, u(le, R), ce.prototype.nodeName = "#document-fragment", ce.prototype.nodeType = A, u(ce, R), ue.prototype.nodeType = w, u(ue, R), he.prototype.serializeToString = function(e, t, r) {
				...
				t.DocumentType = oe, t.DOMException = T, t.DOMImplementation = k, t.Element = K, t.Node = R, t.NodeList = N, t.XMLSerializer = he;
			},
			6559: (e, t, r) => {
				"use strict";
				var a = r(4582).freeze;
			...
			4466: (e, t, r) => {
				...
				function u(e, t, r, n, o, i) {
					...
					for (var l, c = ++t, u = 0;;) {
						...
						switch (h) {
							...
							case "\"":
								if (3 === u || 1 === u) {
									if (1 === u && (i.warning("attribute value must after \"=\""), l = e.slice(t, c)), t = c + 1, !((c = e.indexOf(h, t)) > 0)) throw new Error("attribute value no end '" + h + "' match");
									s(l, d = e.slice(t, c), t - 1), u = 5;
								} else {
									if (4 != u) throw new Error("attribute value must after \"=\"");
									s(l, d = e.slice(t, c), t), i.warning("attribute \"" + l + "\" missed start quot(" + h + ")!!"), t = c + 1, u = 5;
								}
								break;
							case "/":
								switch (u) {
									case 0: r.setTagName(e.slice(t, c));
									case 5:
									case 6:
									case 7: u = 7, r.closed = !0;
									case 4:
									case 1: break;
									case 2:
										r.closed = !0;
								...
								break;
							case "": return i.error("unexpected end of input"), 0 == u && r.setTagName(e.slice(t, c)), c;
							case ">":
								switch (u) {
									case 0: r.setTagName(e.slice(t, c));
									case 5:
									...
									case 7: break;
									case 4:
									case 1: "/" === (d = e.slice(t, c)).slice(-1) && (r.closed = !0, d = d.slice(0, -1));
									case 2:
										2 === u && (d = l), 4 == u ? (i.warning("attribute \"" + d + "\" missed quot(\")!"), s(l, d, t)) : (a.isHTML(n[""]) && d.match(/^(?:disabled|checked|selected)$/i) || i.warning("attribute \"" + d + "\" missed value!! \"" + d + "\" instead!!"), s(d, d, t));
										break;
									case 3: throw new Error("attribute value missed!!");
								}
								return c;
							case "": h = " ";
							default: if (h <= " ") switch (u) {
								case 0:
								...
								case 2:
									r.tagName, a.isHTML(n[""]) && l.match(/^(?:disabled|checked|selected)$/i) || i.warning("attribute \"" + l + "\" missed value!! \"" + l + "\" instead2!!"), s(l, l, t), t = c, u = 1;
									break;
								case 5: i.warning("attribute space is required\"" + l + "\"!!");
								case 6:
									u = 1, t = c;
									break;
								case 3:
									u = 4, t = c;
									break;
								case 7: throw new Error("elements closed character '/' and '>' must be connected to");
							}
						}
						c++;
					}
				...
				function h(e, t, r) {
					for (var n = e.tagName, o = null, i = e.length; i--;) {
						...
						if ((m = l.indexOf(":")) > 0) var u = s.prefix = l.slice(0, m), h = l.slice(m + 1), d = "xmlns" === u && h;
						else h = l, u = null, d = "xmlns" === l && "";
						s.localName = h, !1 !== d && (o ?? (o = {}, p(r, r = {})), r[d] = o[d] = c, s.uri = a.XMLNS, t.startPrefixMapping(d, c));
					}
					for (i = e.length; i--;) (u = (s = e[i]).prefix) && ("xml" === u && (s.uri = a.XML), "xmlns" !== u && (s.uri = r[u || ""]));
					var m;
					(m = n.indexOf(":")) > 0 ? (u = e.prefix = n.slice(0, m), h = e.localName = n.slice(m + 1)) : (u = null, h = e.localName = n);
					var f = e.uri = r[u || ""];
					if (t.startElement(f, h, n, e), !e.closed) return e.currentNSMap = r, e.localNSMap = o, !0;
				...
				function d(e, t, r, a, n) {
					if (/^(?:script|textarea)$/i.test(r)) {
						...
						if (/[&<]/.test(i)) return /^script$/i.test(r) ? (n.characters(i, 0, i.length), o) : (i = i.replace(/&#?\w+;/g, a), n.characters(i, 0, i.length), o);
					}
					return t + 1;
				}
				function m(e, t, r, a) {
					var n = a[r];
					return n ?? ((n = e.lastIndexOf("</" + r + ">")) < t && (n = e.lastIndexOf("</" + r)), a[r] = n), n < t;
				}
				function p(e, t) {
					for (var r in e) Object.prototype.hasOwnProperty.call(e, r) && (t[r] = e[r]);
				}
				function f(e, t, r, a) {
					if ("-" === e.charAt(t + 2)) return "-" === e.charAt(t + 3) ? (n = e.indexOf("-->", t + 4)) > t ? (r.comment(e, t + 4, n - t - 4), n + 3) : (a.error("Unclosed comment"), -1) : -1;
				...
				s.prototype = /* @__PURE__ */ new Error(), s.prototype.name = s.name, l.prototype = { parse: function(e, t, r) {
					...
					n.startDocument(), p(t, t = {}), function(e, t, r, n, o) {
						...
						for (var w = 0, b = 0, v = /.*(?:\r\n?|\n)|.*$/g, C = n.locator, A = [{ currentNSMap: t }], E = {}, y = 0;;) {
							try {
								var _ = e.indexOf("<", y);
								if (_ < 0) {
								...
								switch (_ > y && l(_), e.charAt(_ + 1)) {
									case "/":
										...
										M < 0 ? (T = e.substring(_ + 2).replace(/[\s<].*/, ""), o.error("end tag name: " + T + " is not complete:" + N.tagName), M = _ + 1 + T.length) : T.match(/\s</) && (T = T.replace(/[\s<].*/, ""), o.error("end tag name: " + T + " maybe not complete"), M = _ + 1 + T.length);
									...
									default:
										...
										if (!S.closed && m(e, M, S.tagName, E) && (S.closed = !0, r.nbsp || o.warning("unclosed xml attribute")), C && P) {
			...
			4279: function(e, t, r) {
				...
				Object.defineProperty(t, "__esModule", { value: !0 }), n(r(828), t), n(r(5975), t), n(r(799), t), n(r(2424), t);
			},
			5975: (e, t) => {
				"use strict";
				...
				class r {
					...
					static join(e, t, a = "") {
						return new r(t.length > 0 ? t : void 0 !== a ? [a] : [])._join(e);
					}
					_join(e) {
			...
			2424: (e, t) => {
				"use strict";
				Object.defineProperty(t, "__esModule", { value: !0 }), t.normalizeWhiteSpaces = void 0, t.normalizeWhiteSpaces = (e) => e.replace(/\s+/g, " ");
			},
			7192: (e, t, r) => {
				"use strict";
			...
			9376: (e, t, r) => {
				...
				t.GenericUnderOver = class {
					...
					_applyCommand(e, t) {
						return new i(this._mathmlElement.name.match(/under/) ? s.Under : s.Over).apply(e, t);
					}
				};
				class i {
					constructor(e) {
			...
			1678: (e, t, r) => {
				...
				t.MAction = class {
					...
					convert() {
						...
						return this._isToggle() ? e.map(((e) => (0, a.mathMLElementToLaTeXConverter)(e))).map(((e) => e.convert())).join(" \\Longrightarrow ") : (0, a.mathMLElementToLaTeXConverter)(e[0]).convert();
					}
					_isToggle() {
			...
			2631: (e, t, r) => {
				...
				t.MEnclose = class {
					...
					convert() {
						const e = this._mathmlElement.children.map(((e) => (0, a.mathMLElementToLaTeXConverter)(e))).map(((e) => e.convert())).join(" ");
						return "actuarial" === this._notation ? `\\overline{\\left.${e}\\right|}` : "radical" === this._notation ? `\\sqrt{${e}}` : [
							"box",
							"roundedbox",
							"circle"
						].includes(this._notation) ? `\\boxed{${e}}` : "left" === this._notation ? `\\left|${e}` : "right" === this._notation ? `${e}\\right|` : "top" === this._notation ? `\\overline{${e}}` : "bottom" === this._notation ? `\\underline{${e}}` : "updiagonalstrike" === this._notation ? `\\cancel{${e}}` : "downdiagonalstrike" === this._notation ? `\\bcancel{${e}}` : "updiagonalarrow" === this._notation ? `\\cancelto{}{${e}}` : ["verticalstrike", "horizontalstrike"].includes(this._notation) ? `\\hcancel{${e}}` : "madruwb" === this._notation ? `\\underline{${e}\\right|}` : "phasorangle" === this._notation ? `{\\angle \\underline{${e}}}` : `\\overline{\\left.\\right)${e}}`;
					}
					get _notation() {
			...
			9511: (e, t, r) => {
				...
				t.MFenced = class {
					constructor(e) {
						this._mathmlElement = e, this.open = this._mathmlElement.attributes.open || "", this.close = this._mathmlElement.attributes.close || "";
					}
					convert() {
			...
			7037: (e, t, r) => {
				...
				t.MI = class {
					...
					wrapInMathVariant(e, t) {
						switch (t) {
							case "bold": return `\\mathbf{${e}}`;
							case "italic": return `\\mathit{${e}}`;
							case "bold-italic": return `\\mathbf{\\mathit{${e}}}`;
							case "double-struck": return `\\mathbb{${e}}`;
							case "bold-fraktur": return `\\mathbf{\\mathfrak{${e}}}`;
							case "script": return `\\mathcal{${e}}`;
							case "bold-script": return `\\mathbf{\\mathcal{${e}}}`;
							case "fraktur": return `\\mathfrak{${e}}`;
							case "sans-serif": return `\\mathsf{${e}}`;
							case "bold-sans-serif": return `\\mathbf{\\mathsf{${e}}}`;
							case "sans-serif-italic": return `\\mathsf{\\mathit{${e}}}`;
							case "sans-serif-bold-italic": return `\\mathbf{\\mathsf{\\mathit{${e}}}}`;
							case "monospace": return `\\mathtt{${e}}`;
							default: return e;
						}
					}
				};
			...
			8303: (e, t, r) => {
				...
				t.MMultiscripts = class {
					...
					_prescriptLatex() {
						const { children: e } = this._mathmlElement;
						let t, r;
						if (this._isPrescripts(e[1])) t = e[2], r = e[3];
						else {
			...
			6346: (e, t, r) => {
				...
				t.MRow = class {
					...
					convert() {
						return this._isLinearSystemPattern() ? this._convertAsLinearSystem() : this._mathmlElement.children.map(((e) => (0, a.mathMLElementToLaTeXConverter)(e))).map(((e) => e.convert())).join(" ");
					}
				...
				class n {
					...
					get _commands() {
						switch (this._mathvariant) {
							...
							case "bold-italic": return ["\\textit", "\\textbf"];
							case "double-struck": return ["\\mathbb"];
							case "monospace": return ["\\mathtt"];
							case "bold-fraktur":
			...
			1222: (e, t, r) => {
				...
				t.MUnderover = class {
					...
					convert() {
						const { name: e, children: t } = this._mathmlElement, r = t.length;
						if (3 !== r) throw new n.InvalidNumberOfChildrenError(e, 3, r);
						return `${(0, a.mathMLElementToLaTeXConverter)(t[0]).convert()}_{${(0, a.mathMLElementToLaTeXConverter)(t[1]).convert()}}^{${(0, a.mathMLElementToLaTeXConverter)(t[2]).convert()}}`;
					}
				};
			},
			9165: (e, t) => {
			...
			9208: function(e, t, r) {
				...
				Object.defineProperty(t, "__esModule", { value: !0 }), n(r(9548), t), n(r(5243), t), n(r(1101), t);
			},
			1101: (e, t) => {
				"use strict";
				Object.defineProperty(t, "__esModule", { value: !0 }), t.ElementsToMathMLAdapter = void 0, t.ElementsToMathMLAdapter = class {
					...
					_convertElementAttributes(e) {
						return Array.from(e).reduce(((e, t) => Object.assign({ [t.nodeName]: t.nodeValue === t.nodeName ? "" : t.nodeValue }, e)), {});
					}
					_hasElementChild(e) {
			...
			9548: function(e, t, r) {
				...
				t.XmlToMathMLAdapter = class {
					...
					convert(e) {
						return this._xml = this._removeLineBreaks(e), this._xml = this._removeMsWordPrefixes(this._xml), this._elementsConvertor.convert(this._mathMLElements);
					}
					_fixError(e) {
					...
					get _mathMLElements() {
						...
						return this._errorHandler.isThereAnyErrors() && (this._errorHandler.cleanErrors(), e = this._xmlDOM.parseFromString(this._xml).getElementsByTagName("math")), Array.from(e);
					}
				};
			},
			7941: function(e, t, r) {
				...
				Object.defineProperty(t, "__esModule", { value: !0 }), n(r(8585), t);
			},
			8585: (e, t, r) => {
				"use strict";
			...
			8672: function(e, t, r) {
				...
				Object.defineProperty(t, "__esModule", { value: !0 }), n(r(3798), t);
			},
			3798: (e, t, r) => {
				"use strict";
			...
			2965: (e, t) => {
				"use strict";
				Object.defineProperty(t, "__esModule", { value: !0 }), t.allMathOperatorsByChar = void 0, t.allMathOperatorsByChar = {
					_: "\\underline",
					"&#x23E1;": "\\underbrace",
					"&#x23E0;": "\\overbrace",
					"&#x23DF;": "\\underbrace",
			...
			9039: (e, t) => {
				"use strict";
				Object.defineProperty(t, "__esModule", { value: !0 }), t.allMathOperatorsByGlyph = void 0, t.allMathOperatorsByGlyph = {
					_: "\\underline",
					"⏡": "\\underbrace",
					"⏠": "\\overbrace",
					"⏟": "\\underbrace",
			...
			8249: (e, t) => {
				"use strict";
				Object.defineProperty(t, "__esModule", { value: !0 }), t.allMathSymbolsByChar = void 0, t.allMathSymbolsByChar = {
					"&#xA0;": "\\textrm{ }",
					"&#x2203;": "\\exists",
					"&#x2200;": "\\forall",
					"&#x21D4;": "\\iff",
			...
			8171: (e, t) => {
				"use strict";
				Object.defineProperty(t, "__esModule", { value: !0 }), t.allMathSymbolsByGlyph = void 0, t.allMathSymbolsByGlyph = {
					" ": "\\textrm{ }",
					"∃": "\\exists",
					"∀": "\\forall",
					"⇔": "\\iff",
			...
			5406: function(e, t, r) {
				...
				Object.defineProperty(t, "__esModule", { value: !0 }), n(r(2965), t), n(r(9039), t), n(r(8249), t), n(r(8171), t), n(r(472), t), n(r(4320), t), n(r(6122), t);
			},
			472: (e, t) => {
				"use strict";
				Object.defineProperty(t, "__esModule", { value: !0 }), t.latexAccents = void 0, t.latexAccents = [
					"\\hat",
					"\\bar",
					"\\underbrace",
					"\\overbrace"
			...
			4320: (e, t) => {
				"use strict";
				Object.defineProperty(t, "__esModule", { value: !0 }), t.mathNumberByGlyph = void 0, t.mathNumberByGlyph = {
					"₀": "_{0}",
					"₁": "_{1}",
					"₂": "_{2}",
					"₃": "_{3}",
			...
			6122: (e, t) => {
				...
				Object.defineProperty(t, "__esModule", { value: !0 }), t.HashUTF8ToLtXConverter = void 0, t.HashUTF8ToLtXConverter = class {
					convert(e) {
						...
						const t = r[e];
						if (t) return this.convertAccentCharToLtX(t) || e;
		...
		return (() => {
			"use strict";
			var e = a;
			Object.defineProperty(e, "__esModule", { value: !0 }), e.MathMLToLaTeX = void 0;
			var t = r(8672);
...
//#endregion
export default require_bundle_min();
