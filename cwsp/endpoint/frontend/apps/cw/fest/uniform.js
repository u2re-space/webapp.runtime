import { A as UUIDv4, B as isNotComplexArray, R as isCanJustReturn, T as deepOperateAndClone, U as isPrimitive, w as Promised, z as isCanTransfer } from "./object.js";
...
//#endregion
//#region shared/fest/uniform/newer/messaging/MessageQueue.ts
...
var UnifiedMessagingManager = class {
	constructor(config = {}) {
		...
		this.workerChannels = /* @__PURE__ */ new Map();
		this.viewChannels = /* @__PURE__ */ new Map();
		this.pipelines = /* @__PURE__ */ new Map();
		this.initializedViews = /* @__PURE__ */ new Set();
		this.viewReadyPromises = /* @__PURE__ */ new Map();
		this.componentRegistry = /* @__PURE__ */ new Map();
		this.replayGuard = new ProtocolReplayGuard(300);
		this.localChannelId = "";
...
//#endregion
//#region shared/fest/uniform/newer/messaging/ServiceChannelManager.ts
/**
...
var ServiceChannelManager = class {
	constructor(config = {}) {
		this.channels = /* @__PURE__ */ new Map();
		this.readyPromises = /* @__PURE__ */ new Map();
...
//#endregion
export { normalizeProtocolEnvelope as a, detectExecutionContext as c, isProtocolEnvelope as i, supportsDedicatedWorkers as l, getUnifiedMessaging as n, createQueuedOptimizedWorkerChannel as o, createProtocolEnvelope as r, createWorkerChannel as s, createServiceChannelManager as t, QueuedWorkerChannel as u };
