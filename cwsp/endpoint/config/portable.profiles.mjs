/**
 * Used by `npm run portable:generate` — writes `portable-core.json` / `portable-endpoint.json`.
 * Per-host portable files (`portable.config.json` vs `portable.config.110.json`) are maintained
