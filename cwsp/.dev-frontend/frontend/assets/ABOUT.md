...
<div style="margin: 0px; inline-size: 100%; text-align: end; margin-block-end: 2em;"> <span style="font-size: 0.8em;">At moment of 08.04.2025.</span> </div>

*Desktop-like web link-book, bookmarks (speed-dial) environment. Made for fun since Feb 2024.*

---

## Features

<div style="display: flex; align-items: start; gap: 1rem; inline-size: 100%; justify-items: center; justify-content: stretch; flex-wrap: wrap;">
