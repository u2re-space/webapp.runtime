...
import { M as fetchSwCachedEntries, i as createTemplateManager } from "../com/service.js";
	...
	*/
	...
	const renderHistoryView = async () => {
      ...
      <span>Loading History...</span>
		...
		content.append(loadingElement);
		try {
			const historyManager = (await getCachedComponent("history-manager", () => import("../com/app.js").then((n) => n.o), { componentName: "HistoryManager" })).component.createHistoryManager();
