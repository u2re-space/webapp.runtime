import { Ln as preloadStyle, M as BaseElement, an as H, n as subscribeViewChannel, nn as property, t as postViewChannelPayload, tn as defineElement, yt as __decorate } from "../com/app.js";
import { r as ShellBase, y as isEnabledView } from "./base.js";
//#region src/frontend/shells/window/index.scss?inline
...
//#endregion
//#region src/frontend/shells/window/components/WindowFrame.ts
var styled = preloadStyle("@property --min-block-size{syntax:\"<length-percentage>\";inherits:false;initial-value:480px}@property --min-inline-size{syntax:\"<length-percentage>\";inherits:false;initial-value:640px}@property --drag-x{syntax:\"<length-percentage>\";inherits:false;initial-value:0px}@property --drag-y{syntax:\"<length-percentage>\";inherits:false;initial-value:0px}@property --resize-x{syntax:\"<length-percentage>\";inherits:false;initial-value:0px}@property --resize-y{syntax:\"<length-percentage>\";inherits:false;initial-value:0px}@property --scale{syntax:\"<number>\";inherits:false;initial-value:1}@property --shift-x{syntax:\"<length-percentage>\";inherits:false;initial-value:0px}@property --shift-y{syntax:\"<length-percentage>\";inherits:false;initial-value:0px}@property --initial-inline-size{syntax:\"<length-percentage>\";inherits:false;initial-value:640px}@property --initial-block-size{syntax:\"<length-percentage>\";inherits:false;initial-value:480px}:host{color-scheme:inherit;display:grid;flex-direction:column;overflow:visible;pointer-events:auto;position:absolute;touch-action:none;user-select:none;--min-block-size:480px;--min-inline-size:640px;--_size-x:calc(var(--initial-inline-size, 640px) + var(--resize-x, 0px));--_size-y:calc(var(--initial-block-size, 480px) + var(--resize-y, 0px));block-size:clamp(var(--min-block-size,480px),var(--_size-y),100% - var(--shift-y,0px))!important;inline-size:clamp(var(--min-inline-size,640px),var(--_size-x),100% - var(--shift-x,0px))!important;inset-block-start:clamp(0px,var(--shift-y,0px),100% - var(--min-block-size,480px))!important;inset-inline-start:clamp(0px,var(--shift-x,0px),100% - var(--min-inline-size,640px))!important;max-block-size:min(100% - var(--shift-y,0px),100%)!important;max-inline-size:min(100% - var(--shift-x,0px),100%)!important;min-block-size:var(--min-block-size,480px)!important;min-inline-size:var(--min-inline-size,640px)!important;transform:scale3d(var(--scale,1),var(--scale,1),var(--scale,1)) translate3d(var(--drag-x,0),var(--drag-y,0),0);transition:box-shadow .15s ease}:host(.is-maximized){block-size:100%!important;inline-size:100%!important;inset-block-start:0!important;inset-inline-start:0!important;transform:none!important;--frame-radius:0}@media (max-width:900px){:host(:not(.is-maximized)){--shift-x:0!important;--shift-y:0!important;--drag-x:0!important;--drag-y:0!important;block-size:100%!important;inline-size:100%!important;inset-block-start:0!important;inset-inline-start:0!important;min-block-size:min(var(--min-block-size,480px),100%);min-inline-size:min(var(--min-inline-size,640px),100%);transform:none!important;--frame-radius:0}}.frame{backdrop-filter:blur(12px);background:light-dark(rgba(255,255,255,.92),rgba(14,18,28,.88));border:1px solid light-dark(rgba(0,0,0,.1),rgba(120,140,180,.18));border-radius:var(--frame-radius,14px);box-shadow:light-dark(0 8px 32px rgba(0,0,0,.08),0 0 0 .5px rgba(0,0,0,.06),0 8px 32px rgba(0,0,0,.35),0 0 0 .5px rgba(255,255,255,.06));color:light-dark(#1a1c2b,#edf2ff);display:flex;flex:1 1 0%;flex-direction:column;min-block-size:min(var(--min-block-size,480px),100%);min-inline-size:min(var(--min-inline-size,640px),100%);overflow:hidden}:host(.is-active) .frame{border-color:light-dark(rgba(59,125,219,.22),rgba(139,183,255,.22));box-shadow:light-dark(0 12px 42px rgba(0,0,0,.12),0 0 0 .5px rgba(59,125,219,.15),0 12px 42px rgba(0,0,0,.42),0 0 0 .5px rgba(139,183,255,.15))}:host(.is-maximized) .frame{border-color:transparent;border-radius:0}:host(.is-drop-target) .frame{border-color:light-dark(rgba(59,125,219,.35),rgba(139,183,255,.35));box-shadow:0 0 0 1px light-dark(rgba(59,125,219,.2),rgba(139,183,255,.2)),0 12px 42px light-dark(rgba(0,0,0,.12),rgba(0,0,0,.42))}.bar{align-items:center;background:light-dark(rgba(245,247,252,.95),rgba(22,28,42,.7));border-block-end:1px solid light-dark(rgba(0,0,0,.06),rgba(255,255,255,.04));cursor:default;display:flex;flex:0 0 auto;gap:.4rem;min-block-size:36px;padding:.3rem .6rem;user-select:none}.title{flex:1 1 auto;font-size:.84rem;font-weight:500;opacity:.88;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.pid{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.7rem;opacity:.4}.btns{display:flex;gap:.15rem}button{background:transparent;border:0;border-radius:6px;color:inherit;cursor:pointer;font-size:.82rem;line-height:1;opacity:.5;padding:.22rem .42rem;transition:opacity .1s ease,background .1s ease}button:hover{background:light-dark(rgba(0,0,0,.06),rgba(255,255,255,.1));opacity:1}button[data-window-action=popout]{font-size:.76rem}button[data-window-action=close]:hover{background:rgba(220,60,60,.45);opacity:1}.content{box-sizing:border-box;display:flex;flex:1 1 0%;flex-direction:column;inline-size:100%;min-block-size:0;min-inline-size:0;overflow:hidden;position:relative}::slotted(*){box-sizing:border-box;flex:1 1 0%;inline-size:100%;min-block-size:0;min-inline-size:0;overflow:auto}.resize{background:linear-gradient(135deg,transparent 40%,currentColor 41%,currentColor 49%,transparent 50%,transparent 60%,currentColor 61%,currentColor 69%,transparent 70%);block-size:18px;cursor:nwse-resize;inline-size:18px;inset:auto 0 0 auto;opacity:.3;position:absolute;transition:opacity .12s ease;z-index:1}.resize:hover{opacity:.55}:host(.is-maximized) .resize{display:none}");
var WindowFrameV2 = class WindowFrameV2 extends BaseElement {
	windowTitle = "Window";
	windowPid = "";
	titleEl;
	pidEl;
...
__decorate([property({
	source: "attr",
	name: "data-title"
})], WindowFrameV2.prototype, "windowTitle", void 0);
__decorate([property({
	source: "attr",
	name: "data-pid"
})], WindowFrameV2.prototype, "windowPid", void 0);
__decorate([property({
	source: "query-shadow",
	name: "[data-title]"
})], WindowFrameV2.prototype, "titleEl", void 0);
__decorate([property({
	source: "query-shadow",
	name: "[data-pid]"
})], WindowFrameV2.prototype, "pidEl", void 0);
__decorate([property({
	source: "query-shadow",
	name: "[data-drag-handle]"
})], WindowFrameV2.prototype, "dragHandle", void 0);
__decorate([property({
	source: "query-shadow",
	name: "[data-resize-handle]"
})], WindowFrameV2.prototype, "resizeHandle", void 0);
WindowFrameV2 = __decorate([defineElement("cw-window-frame-v2")], WindowFrameV2);
//#endregion
//#region src/frontend/shells/window/index.ts
/**
* Window Shell
*
...
var WindowShell = class extends ShellBase {
	...
	*/
	async openView(viewId, options) {
		...
		if (openParams.attachments?.length) proc.channel.post({
			type: "process-attach",
	...
	*/
	async loadWindowView(viewId, openParams) {
		...
		try {
			const { ViewRegistry } = await import("../chunks/registry.js");
	...
	*/
	installDropTarget(proc) {
		...
		body.addEventListener("drop", (e) => {
			...
			if (attachments.length > 0) proc.channel.post({
				type: "process-attach",
				pid: proc.pid,
				viewId: proc.viewId,
				attachments
...
function createShell$1(_container) {
...
//#endregion
export { createShell$1 as i, createShell as n, WindowShell as r, ContentShell as t };
