...
import { D as createViewState, E as BaseElement_default, Fn as loadAsAdopted, Gt as parseDataUrl, Ht as decodeBase64ToBytes, Jt as openDirectory, O as renderMathInElement, Rn as removeAdopted, Tt as reinitializeRegistry, Ut as isBase64Like, Wt as normalizeDataAsset, Yt as provide, an as H, cn as affected, dt as writeText, fn as ref, k as purify, pt as loadSettings, tn as defineElement, wt as ensureStyleSheet, yt as __decorate } from "../com/app.js";
...
var getMarkedParser = async () => {
	...
	markedParserPromise = (async () => {
		const [{ marked }, { default: markedKatex }] = await Promise.all([import("../com/app.js").then((n) => n._), import("../com/app.js").then((n) => n.h)]);
...
var ViewerView = class ViewerView extends BaseElement_default {
	...
	*/
	...
	async handleExportDocx() {
		...
		try {
			const { downloadMarkdownAsDocx } = await import("../com/app.js").then((n) => n.p);
