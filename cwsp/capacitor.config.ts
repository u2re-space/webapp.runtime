 ...
 *
 * This file MUST live next to cwsp-runtime `package.json`. `@capacitor/cli` only loads config
 * from the project root (`cwd` for `cap sync`); a copy under `endpoint/` is ignored.
 *
