...
const copyEntry = async (name) => {
    ...
    if (name === "airpad") {
        try {
            ...
            console.warn("[portable] airpad symlink missing or unreadable. Skipping airpad copy.");
            return;
        }
    }
...
Generated by \`runtime/scripts/pack-portable.mjs\` from the endpoint workspace in this tree.
